...
def read_database_configs():
    ...
    """
    config_file = CONFIG_PATH + "/database.configs"
...
def read_modules_configs():
    """
        ...
        Returns:
            dictionary: database configs
    """
    config_file = CONFIG_PATH + "/modules.configs"
...
def read_openflow_configs():
    ...
    """
    config_file = CONFIG_PATH + "/openflow.configs"
...
def read_sdnlg_configs():
    """
        ...
        Returns:
            dictionary: database configs
    """
    config_file = CONFIG_PATH + "/sdnlg.configs"
...
def read_messagebroker_configs():
    ...
    """
    config_file = CONFIG_PATH + '/messagebroker.configs'
...
def read_controllers_configs():
    config_file = CONFIG_PATH + '/controllers.configs'
    options = ['CONTROLLERS', ]
    dictionary = {
...
def read_snmp_configs():
    config_file = CONFIG_PATH + '/snmp.configs'
    pass
